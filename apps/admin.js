  ...
  async admin () {
    const actions = [
      ...
      },
      {
        ...
        action: (msg) => {
          this.yamlData('Config-Server', 'InvalidTime', Number(msg))
        }
      },
      {
      ...
      li: [
        {
          line: '开关',
          hint: '#铃音设置标准输入 开启/关闭',
          status: Adapter.Stdin.state
        },
        {
          line: '名称',
          hint: '#铃音设置标准输入名称 标准输入',
          status: Adapter.Stdin.name,
          desc: '椰奶状态、土块状态中显示名称'
        }
      ]
    })
      ...
      li: [
        {
          ...
          status: Adapter.Shamrock.baseUrl ? '已设置' : '未设置',
          desc: '暂未实现'
        },
        {
          line: '鉴权Token',
          hint: '#铃音设置三叶草token abc123',
          status: Adapter.Shamrock.token ? '已设置' : '未设置',
          desc: 'HTTP请求鉴权token，如果开放公网强烈建议配置'
        },
        {
          line: 'Github Token',
          hint: '#铃音设置三叶草Git abc123',
          status: Adapter.Shamrock.githubKey ? '已设置' : '未设置',
      ...
      li: [
        {
          ...
          status: Adapter.ComWeChat.name ? Adapter.ComWeChat.name : '未设置',
          desc: '椰奶状态、土块状态中显示名称'
        },
        {
          line: '自动同意好友',
          hint: '#铃音设置PC微信好友 开启/关闭',
          status: Adapter.ComWeChat.autoFriend,
      ...
      li: [
        {
          ...
          status: Adapter.WeXin.name ? Adapter.WeXin.name : '未设置',
          desc: '椰奶状态、土块状态中显示名称'
        },
        {
          line: '自动同意好友',
          hint: '#铃音设置微信好友 开启/关闭',
          status: Adapter.WeXin.autoFriend,
