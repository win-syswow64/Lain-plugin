...
//    return await this.SendApi(id, 'send_group_msg', params)
  ...
  */
  async send_like (id, user_id, times) {
    ...
    return await this.SendApi(id, 'send_like', user_id, times )
  },
  ...
  */
  async get_group_msg_history (id, group_id, count, message_seq) {
    const params = { group_id, message_seq, count }
  ...
  */
  async get_friend_msg_history (id, user_id, count, message_seq) {
    const params = { user_id, message_seq, count }
  ...
  */
  async get_file (id, file_id) {
    const params = { file_id }
    return await this.SendApi(id, 'get_file', params)
  },
